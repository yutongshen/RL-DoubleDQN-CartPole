...
- Double Deep Q Network
  ...
  - Update the θ for the state using the observed reward and the maximum reward possible for the next state.
    ...
    - ![\theta=\theta-lr\cdotL\cdot\triangledown\_\thetaQ(s,a;\theta)](https://latex.codecogs.com/svg.latex?\theta=\theta-lr\cdot%20L\cdot\triangledown_\theta%20Q%28s,a;\theta%29)
