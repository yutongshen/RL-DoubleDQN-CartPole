...
- Double Deep Q Network
  ...
  - Update the θ for the state using the observed reward and the maximum reward possible for the next state.
    - ![loss=(r+\gammaQ(s',argmax\_{a'}Q(s',a';\theta);\theta^{-})-Q(s,a:\theta))^{2}](https://latex.codecogs.com/svg.latex?loss=%28r+\gamma%20Q(s',argmax_{a%27}Q%28s%27,a%27;\theta%29;\theta^{-}%29-Q%28s,a;\theta%29%29^{2})
